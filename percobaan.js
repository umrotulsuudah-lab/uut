...
document.getElementById('mute-btn').addEventListener('click', () => {
    ...
    if (isMuted) {
        bgMusic.pause();
        // Mute icon (Pastikan Path Ikon Mute)
...
const materialData = [
    {
        title: "Pengantar Kediri Raya & Ikon Kota 🏙️",
        content: "Kediri dikenal sebagai **'Kota Tahu'** dan merupakan salah satu kota tertua di Jawa Timur, eksis sejak abad ke-9 Masehi. Wilayah ini terbelah oleh **Sungai Brantas** dan dikelilingi oleh pegunungan. Ikon utama dan kebanggaan Kediri adalah **Simpang Lima Gumul (SLG)**, sebuah monumen yang meniru Arc de Triomphe di Paris, menjadi titik temu lima jalur utama."
    },
    {
        title: "Sejarah Kerajaan & Sastra 📜",
        content: "Kediri adalah pusat **Kerajaan Kediri** (abad ke-11 hingga ke-13 M), yang merupakan pecahan dari Kerajaan Mataram Kuno. Raja paling terkenal adalah **Prabu Jayabaya**, yang ramalannya **'Jangka Jayabaya'** sangat legendaris. Pada masa ini lahir karya sastra epik seperti **Kitab Bharatayuddha** (oleh Mpu Sedah dan Mpu Panuluh) dan **Kakawin Smaradahana** (oleh Mpu Darmajaya). Keruntuhan kerajaan terjadi pada tahun **1222 Masehi** setelah dikalahkan Ken Arok."
    },
    {
        title: "Geografi, Alam, dan Pariwisata ⛰️",
        content: "Kediri diapit oleh **Gunung Wilis** (barat) dan **Gunung Kelud** (timur). Destinasi populer meliputi: **Air Terjun Dolo** (di lereng Wilis), pemandangan kawah **Gunung Kelud**, dan **Petirtaan Jolotundo** (situs bersejarah berupa pemandian kuno). Ibukota Kabupaten Kediri berada di **Kecamatan Ngasem**. Kediri juga memiliki bandar udara baru, **Dhoho International Airport**."
    },
    {
        title: "Kuliner Khas & Ciri Unik 🍴",
        content: "Kuliner wajib coba Kediri: **Nasi Pecel Tumpang** (menggunakan sambal tumpang dari tempe bosok) dan **Tahu Kuning** khas Kediri. Penganan ringan populer adalah **Stik Tahu** (dari ampas tahu). Slogan Kabupaten Kediri adalah **'Kediri Lagi'**. Hari jadi Kota Kediri sering dihubungkan dengan tahun **879 Masehi**."
    },
    {
        title: "Seni dan Budaya Lokal 🎭",
        content: "Kesenian khas Kediri meliputi **Tari Topeng Panji** (tarian penyambutan) dan **Wayang Krucil** (pertunjukan wayang rakyat). Tokoh legenda yang sering diangkat adalah **Panji dan Sekartaji**. Kerajinan tangan unggulan adalah **Tenun Ikat** yang terkenal hingga mancanegara."
    }
];
...
// --- Utility Functions (NAVIGASI DIUBAH KE MATERIAL) ---

/**
 * Toggles the visibility of the specified view and applies fade animation.
 * @param {string} viewName - The name of the view (e.g., 'home', 'material', 'level-select').
 */
...
// --- 1. Halaman Utama Logic (MODIFIKASI NAVIGASI) ---
